...
public class PersonalOK extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text = (TextView) findViewById(R.id.personalOK);
        text.setMovementMethod(new ScrollingMovementMethod());
        text.setText("(주)한국정보공작소(이하 ‘회사’)는 다음과 같은 원칙에 의하여 회원의 개인정보를 수집, 이용 및 관리하고 있고, 이와 관련하여 정보통신서비스 제공자가 준수하여야 하는 대한민국의 관계법령 및 개인정보보호 규정, 가이드라인을 준수하고 있습니다.\n" +
                "\n" +
                " \n" +
                "\n" +
